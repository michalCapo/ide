-- nvima: reduced profile derived from nvim/init.lua.
-- Kept: file management, LSP, completion, editing/navigation, UI/shell.
-- Removed: AI agents, Git tools, database viewer, debugger, run configurations.
